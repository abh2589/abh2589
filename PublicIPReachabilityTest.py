...
while z == "y" or z == "Y":
    ...
    try:
        if r1.group() == ", 0% packet loss":
            print(f"\nThe IP Address: {ipaddress} is reachable from AT&T Route server without any packet loss")
            ...
            print(f"IP Address: {ipaddress} is not reachable from public route server 12.0.1.28 , Please check if IP pool is advertised over internet or contact your ISP\n")
            z = input("\nPress y to continue, or press any key to exit:\t")
